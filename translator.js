...
(function () {
  const DICT = {
    ...
    // Lesson 14 September (Feelings, Bali, Navigation, Food)
    "refrigerator": "холодильник (произносится [rɪˈfrɪdʒəreɪtər])",
    "fridge": "холодильник (разговорное сокращение)",
    "confused": "запутавшийся / в замешательстве (чувство)",
    "confusing": "запутанный / сбивающий с толку (объект)",
    "uncountable": "неисчисляемый (в грамматике)",
    "uncomfortable": "неудобный / дискомфортный (одежда, стул)",
    "exhausted": "крайне уставший / совершенно без сил",
    "nervous": "нервничающий / взволнованный",
    "angry": "злой / сердитый",
    "sad": "грустный / печальный",
    "bread": "хлеб (всегда неисчисляемое!)",
    "slice": "ломтик / кусочек", "slices": "кусочки / ломтики",
    "loaf": "буханка", "loaves": "буханки",
    "intersection": "перекрёсток дорог",
    "straight": "прямо (по направлению)",
    "corner": "угол улицы",
    "pharmacy": "аптека",
...
if (typeof module !== "undefined" && module.exports) {
  ...
  "achievements": "достижения / успехи",
  "across": "через / напротив / по ту сторону",
  "after": "после",
  "afternoons": "послеобеденное время",
  "again": "снова / опять / еще раз",
  "aircraft": "самолет / авиация (мн. ч. не меняется)",
  "aircrafts": "ошибка! во мн. ч. только aircraft",
  "alina": "Алина",
  "alina's": "Алины (чей? кого?)",
  "all": "весь / все / всё",
  "along": "вдоль / по",
  "am": "являюсь / нахожусь (форма to be для I)",
  "an": "неопределенный артикль (перед гласными)",
  "and": "и",
  "any": "какой-либо / сколько-нибудь / никакой",
  "apartment": "квартира",
  "apples": "яблоки",
  "apps": "приложения",
  "are": "являются / находитесь (to be для we, you, they)",
  "aren't": "не являются / не находитесь (are not)",
  "around": "около / вокруг / примерно",
  "as": "как / в качестве / так же",
  "asian": "азиатский",
  "assets": "исходники / материалы / ресурсы",
  "at": "в / у / на / около",
  "ate": "съел / съела / съели (прошедшее время от eat)",
  "backpack": "рюкзак",
  ...
  "beach": "пляж",
  "before": "до / перед / раньше",
  "best": "лучший / самый лучший",
  "better": "лучше",
  "bird": "птица",
  "black": "черный",
  "blows": "дует (blow + s)",
  "board": "доска / настольный (board games)",
  "bought": "купил / купила / купили (прошедшее от buy)",
  "boxes": "коробки (ящики)",
  "brightly": "ярко / ослепительно",
  "building": "здание / постройка",
  "but": "но / а / однако",
  "button": "кнопка",
  "by": "у / около / с помощью / на (by car)",
  "call": "звонок / созвон / звать / звонить",
  "calm": "спокойный / тихий",
  "can": "мочь / уметь",
  "cancelling": "отменяющий / подавляющий (noise-cancelling)",
  "car": "машина / автомобиль",
  "card": "карта / карточка / банковская карта",
  "cash": "наличные / наличные деньги",
  "cats": "кошки / коты",
  "center": "центр",
  "chair": "стул",
  "cheap": "дешевый / недорогой",
  "childs": "ошибка! во мн. ч. только children",
  "clean": "чистый / делать чистым",
  "client": "клиент / заказчик",
  "clients": "клиенты / заказчики",
  "closed": "закрытый / закрыто",
  "cloud": "облако / облачный сервис",
  "coffee": "кофе",
  ...
  "could": "мог бы / могли бы (вежливая форма)",
  "counter": "стойка / прилавок",
  "country": "страна / загород",
  "cow": "корова / коровье (cow milk)",
  "create": "создавать",
  "creates": "создает (he/she creates)",
  "cyprus": "Кипр",
  "day": "день",
  "days": "дни",
  ...
  "designer": "дизайнер",
  "designing": "проектирование / разработка дизайна",
  "designs": "дизайны / макеты / проектирует",
  "desk": "письменный стол / рабочий стол",
  "did": "сделал / вспомогательный глагол Past Simple",
  "didn't": "не (did not — отрицание в прошедшем)",
  "digital": "цифровой",
  "dinner": "ужин",
  "do": "делать / вспомогательный глагол для I, you, we, they",
  "does": "делает / вспомогательный глагол для he, she, it",
  "doesn't": "не (does not — отрицание для he, she, it)",
  "dog": "собака",
  "doing": "делающий / делание (doing well — дела идут отлично)",
  "don't": "не (do not — отрицание для I, you, we, they)",
  "dont": "не (don't)",
  "door": "дверь",
  "dota": "Дота (компьютерная игра)",
  "down": "вниз / дальше по (down the street)",
  "drink": "пить / напиток",
  "drinks": "пьет (he/she drinks) / напитки",
  "drive": "водить машину / ехать",
  "during": "во время / в течение",
  "eat": "есть / кушать",
  "eats": "ест (he/she eats)",
  "ed": "окончание прошедшего времени -ed",
  "ee": "буквосочетание ee",
  "eliza": "Элиза (преподаватель)",
  "elvz": "Элиза",
  ...
  "fe": "окончание -fe",
  "fi": "сочетание fi",
  "figma": "Фигма (дизайн-редактор)",
  "filter": "фильтр / фильтр-кофе",
  "find": "находить",
  "fishes": "рыбы (разные биологические виды, обычно fish)",
  "five": "пять",
  "flat": "плоский / флэт уайт (кофе)",
  "fluently": "бегло / свободно (говорить)",
  "food": "еда / пища",
  "foots": "ошибка! во мн. ч. только feet",
  "for": "для / за / в течение",
  "found": "нашел / нашла / нашли (прошедшее от find)",
  "friday": "пятница",
  "friend": "друг",
  "from": "из / от / с",
  "game": "игра",
  "games": "игры",
  "get": "получать / становиться / нагреваться (get hot)",
  "gets": "становится / получает (he/she gets)",
  "glad": "рад / доволен",
  "glasses": "очки / стаканы",
  "go": "идти / ехать",
  "goed": "грубая ошибка! прошедшее от go — went",
  "gone": "ушедший (3-я форма от go)",
  "grammar": "грамматика",
  "great": "отличный / великолепный / великий",
  "greek": "греческий язык / греческий",
  "green": "зеленый",
  "guy": "парень / человек",
  "had": "имел / было (прошедшее время от have)",
  "hand": "рука / кисть руки",
  "hard": "трудный / тяжелый / упорно",
  "has": "имеет (have для he/she/it)",
  "have": "иметь / у меня есть",
  "he": "он",
  "headphones": "наушники",
  "here": "здесь / сюда",
  "home": "дом / дома",
  "hot": "горячий / жарко / нагретый",
  "hotel": "отель / гостиница",
  "hours": "часы (время)",
  "how": "как / сколько (how much, how long)",
  "huge": "огромный",
  "hungry": "голодный",
  "i'd": "я бы (I would)",
  "i'm": "я есть / я (I am)",
  ...
  "into": "в / внутрь",
  "is": "есть / является (to be для he/she/it)",
  "isn't": "не является (is not)",
  "issues": "проблемы / неполадки / вопросы",
  "it": "оно / это",
  "it's": "это есть (it is)",
  ...
  "keys": "ключи / клавиши",
  "know": "знать",
  "knows": "знает (he/she knows)",
  "kt": "сокращение / звук кт",
  "la": "артикль / слог ла",
  "language": "язык (русский, английский)",
  "laptop": "ноутбук",
  "laptops": "ноутбуки",
  "larnaca": "Ларнака (город на Кипре)",
  "last": "прошлый / последний (last night, last week)",
  "ldr": "сокращение ldr",
  "learn": "учить / изучать",
  "lesson": "урок",
  "li": "слог ли",
  "lifes": "ошибка! во мн. ч. только lives",
  "like": "нравиться / любить / как",
  "likes": "нравится (he/she likes)",
  "limassol": "Лимасол (город на Кипре)",
  "live": "жить / обитать",
  "long": "длинный / долгий / долго",
  "look": "смотреть / взгляд / выглядеть",
  "love": "любить / любовь",
  "lunch": "обед",
  "macbook": "Макбук (ноутбук Apple)",
  "managers": "менеджеры",
  "many": "много (для исчисляемых)",
  "marina": "марина (яхтенная гавань в Лимасоле)",
  "me": "мне / меня",
  "mean": "значить / иметь в виду",
  "meet": "встречать / знакомиться (первый раз)",
  "meeting": "встреча / созвон / совещание",
  "meetings": "встречи / совещания",
  "milk": "молоко",
  "mind": "возражать / разум (do you mind — ты не против?)",
  "mobile": "мобильный",
  "modern": "современный",
  "monitor": "монитор / экран",
  "monitors": "мониторы",
  "more": "больше / более",
  "moved": "переехал / переехали",
  "much": "много / сильно (how much — сколько)",
  "my": "мой / моя / моё / мои",
  "na": "частица na",
  "near": "около / рядом с / близко",
  "need": "нуждаться / нужно",
  "needs": "нужно / требуется (he/she needs)",
  "neighborhood": "район / соседство",
  "netflix": "Нетфликс (стриминговый сервис)",
  "new": "новый",
  "nice": "приятный / хороший / красивый",
  "nine": "девять",
  "noise": "шум (noise-cancelling — шумоподавление)",
  "not": "не / нет",
  "now": "сейчас / теперь",
  "oat": "овсяный (oat milk — овсяное молоко)",
  "of": "предлог родительного падежа (кого? чего?)",
  "office": "офис",
  "often": "часто",
  "on": "на / включен / по",
  "one": "один / тот самый (заменитель существительного)",
  "only": "только / единственный",
  "oo": "буквосочетание oo",
  "open": "открывать / открытый",
  "or": "или",
  "order": "заказывать / порядок / заказ",
  "our": "наш / наша / наше / наши",
  "over": "над / через / вон там (over there)",
  "owned": "владел / имел в собственности",
  "paphos": "Пафос (город на Кипре)",
  "parents": "родители",
  "pass": "передавать / проходить",
  "passenger": "пассажир / пассажирский",
  "past": "прошедший / прошлое время",
  "pay": "платить / оплачивать",
  "persons": "лица (официальный термин, в обычной речи people)",
  "phone": "телефон",
  "phones": "телефоны",
  "place": "место / помещать",
  "play": "играть",
  "played": "играл / играли",
  "playing": "играющий / игра",
  "plays": "играет (he/she plays)",
  "please": "пожалуйста",
  "pm": "после полудня (вечернее время)",
  "pool": "бассейн",
  "poster": "плакат / постер",
  "prefer": "предпочитать",
  "present": "настоящее время / подарок / присутствующий",
  "promenade": "набережная / променад",
  "proud": "гордый (proud of — гордящийся кем-то)",
  "ps": "PlayStation / постскриптум",
  "put": "класть / надевать (put on)",
  "quiet": "тихий / спокойный",
  "reading": "чтение / читающий",
  "ready": "готовый",
  "recently": "недавно / в последнее время",
  "recommend": "рекомендовать / советовать",
  "regular": "обычный / регулярный / правильный (глагол)",
  "remember": "помнить / вспоминать",
  "right": "правый / правильный / прямо (right now)",
  "room": "комната",
  "safe": "безопасный / надежный / сейф",
  "salad": "салат",
  "say": "сказать / говорить (произносить слова)",
  "scale": "шкала / масштаб",
  "scissors": "ножницы (всегда мн. ч.)",
  "screen": "экран",
  "sea": "море",
  "seafood": "морепродукты",
  "seat": "сиденье / место",
  "see": "видеть / понимать / встречаться",
  "seems": "кажется (it seems — кажется)",
  "serie": "ошибка! во всех числах только series",
  "sessions": "сессии / рабочие сеансы",
  "several": "несколько",
  "she": "она",
  "shelfs": "ошибка! во мн. ч. только shelves",
  "shine": "сиять / светить",
  "shines": "светит / сияет (the sun shines)",
  "shirt": "рубашка / футболка",
  "shoes": "обувь / туфли",
  "shop": "магазин / кофейня (coffee shop)",
  "simple": "простой (Present Simple)",
  "sings": "поет (sing + s)",
  "sleeps": "спит (sleep + s)",
  "slowly": "медленно",
  "sneakers": "кроссовки",
  ...
  "speak": "говорить / разговаривать (на языке)",
  "speaks": "говорит (he/she speaks)",
  "spend": "тратить / проводить (время)",
  "spent": "потратил / провел время (прошедшее от spend)",
  "spicy": "острый / пряный",
  "standing": "стоящий / стоя",
  "start": "начинать / старт",
  "states": "штаты (United States)",
  "story": "история / сюжетный (story games)",
  "street": "улица",
  ...
  "sunny": "солнечный",
  "sunset": "закат",
  "swimming": "плавание (swimming pool — бассейн)",
  "table": "стол",
  "take": "брать / занимать время (takes 20 minutes)",
  "takes": "занимает времени (it takes)",
  "talking": "разговаривающий / говорящий",
  "tavern": "таверна",
  "taxi": "такси",
  "tea": "чай",
  "teacher": "учитель / преподаватель",
  "tell": "рассказывать / сообщать кому-то",
  "ten": "десять",
  "than": "чем (сравнение: better than)",
  "thank": "благодарить (thank you — спасибо)",
  "that": "тот / та / то (один предмет, на расстоянии)",
  "the": "определенный артикль (тот самый, конкретный)",
  "them": "их / им",
  "there": "там / туда (there is/are — имеется, есть)",
  "these": "эти (много предметов, близко)",
  "they": "они",
  "thirsty": "испытывающий жажду (хочу пить)",
  "this": "этот / эта / это (один предмет, близко)",
  "those": "те (много предметов, на расстоянии)",
  "three": "три",
  "thursday": "четверг",
  "ti": "слог ti",
  "time": "время / раз",
  "to": "к / в / частица инфинитива (to be, to do)",
  "today": "сегодня",
  "too": "тоже / слишком (too hot)",
  "tooths": "ошибка! во мн. ч. только teeth",
  ...
  "types": "печатает (he/she types) / типы",
  "typography": "типографика",
  "ui": "пользовательский интерфейс (UI)",
  "understand": "понимать",
  "united": "соединенный (United States)",
  "until": "до / пока не",
  "usually": "обычно",
  "vacation": "отпуск / каникулы",
  "valery": "Валерий (друг)",
  "very": "очень",
  "video": "видео (video games — видеоигры)",
  "vintage": "винтажный / старинный",
  "visit": "посещать / навещать / визит",
  "vs": "против / в сравнении с (versus)",
  "vz": "звук vz",
  "walk": "гулять / идти пешком",
  "walked": "гулял / прошел пешком (прошедшее от walk)",
  "want": "хотеть",
  "wants": "хочет (he/she wants)",
  "warm": "теплый",
  "was": "был / была / было (Past Simple от to be для I, he, she, it)",
  "water": "вода",
  "we": "мы",
  "weather": "погода",
  "weekend": "выходные дни (суббота и воскресенье)",
  "went": "пошел / поехал (прошедшее время от go)",
  "were": "были (Past Simple от to be для you, we, they)",
  "what": "что / какой",
  "when": "когда",
  "where": "где / куда",
  "who": "кто",
  ...
  "with": "с / вместе с",
  "without": "без",
  "works": "работает (he/she works) / работы",
  "would": "бы (I would like — я бы хотел)",
  "yachts": "яхты",
  "years": "годы / лет",
  "yesterday": "вчера",
  "yet": "еще / пока (not yet — еще нет)",
  "yoga": "йога",
  "you": "ты / вы / тебе / вам",
  "your": "твой / ваш"
};

  Object.assign(DICT, EXPANDED_DICT, CARD_VOCAB);
  ...
  async function getTranslation(rawText) {
    ...
    if (stripped.endsWith("s") && DICT[stripped.slice(0, -1)]) return DICT[stripped.slice(0, -1)];
